...
class Depression {
  List<String> questions = [
    ...
    "Moving or speaking so slowly that others have noticed? Or being fidgety and restless?".tr,
  ...
  static Map<String, dynamic> generateReport(List<int> responses) {
    ...
    String severity;
    if (totalScore >= 20) {
      severity = "Severe depression: It is recommended to seek professional help immediately.".tr;
    } else if (totalScore >= 15) {
      severity = "Moderately severe depression: Consider consulting a healthcare provider.".tr;
    } else if (totalScore >= 10) {
      severity = "Moderate depression: Seeking professional advice may be beneficial.".tr;
    } else if (totalScore >= 5) {
      severity = "Mild depression: Monitoring and self-care strategies might help.".tr;
    } else {
      severity = "Minimal depression: Symptoms are not significant, but self-care is still important.".tr;
    }
